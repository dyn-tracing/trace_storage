...
QueryData height_at_least_four() {
    ...
    query.graph.node_names.insert(std::make_pair(5, ASTERISK_SERVICE));
    query.graph.node_names.insert(std::make_pair(6, ASTERISK_SERVICE));
    // query.graph.node_names.insert(std::make_pair(7, ASTERISK_SERVICE));
    // query.graph.node_names.insert(std::make_pair(8, ASTERISK_SERVICE));
    // query.graph.node_names.insert(std::make_pair(9, ASTERISK_SERVICE));
    ...
    query.graph.edges.insert(std::make_pair(4, 5));
    query.graph.edges.insert(std::make_pair(5, 6));
    // query.graph.edges.insert(std::make_pair(6, 7));
    // query.graph.edges.insert(std::make_pair(7, 8));
    // query.graph.edges.insert(std::make_pair(8, 9));
